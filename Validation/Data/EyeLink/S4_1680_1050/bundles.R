### Bundle 1
# Fixed area 1
bundle_1_fixed_area_1_screen <- c(0, 71, 1679, 120)
bundle_1_fixed_area_1_image <- c(0, 0, 1679, 49)
...
save(fixed_areas, rules, file = file.path("Data", "EyeLink", "S4_1680_1050.RData"))