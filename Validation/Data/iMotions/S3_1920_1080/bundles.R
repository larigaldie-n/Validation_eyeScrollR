### Bundle 1
# Fixed area 1
bundle_1_fixed_area_1_screen <- c(0, 77, 1919, 142)
bundle_1_fixed_area_1_image <- c(0, 0, 1919, 65)
# Fixed area 2
bundle_1_fixed_area_2_screen <- c(1866, 184, 1919, 373)
...
save(fixed_areas, rules, file = file.path("Data", "iMotions", "S3_1920_1080.RData"))